...
\title{Networking Fundamentals}
\subtitle{Introduction to Computer Networks}
\author{Rama Krishna Majety}
\institute{National Centre for Communications Security\\Department of Telecommunications }
...
\setbeamertemplate{title page}
{
    \vbox{}
    \begingroup
    \includegraphics[height=1.5cm]{nccs.png}
    \hfill
    \includegraphics[height=1.5cm]{indemblem.png}\par
        \vskip1em\par
    \centering
